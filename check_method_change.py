...
path_to_parsed = "/drive2/phatnt/zTrans/thieulvd/final_parsed_tmp_tmp"
        ...
        if mode in ["Modified", "Renamed-Modified"]:
            ...
            for item in diff_files[mode]:
                ...
                for bclass in new_classes:
                    if bclass["class_mode"] in ["Modified", "Renamed-Modified"]:
                        for bmethod in bclass["methods"]:
                            total_current += 1
                            match bmethod["method_mode"]:
                                case "Added":
                                    num_added += 1
                                case "Modified":
